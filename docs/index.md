...
Edwin Grimsley, Ph.D. Office Hours: details on Brightspace E-mail: [edwin.grimsley@baruch.cuny.edu](mailto:edwin.grimsley@baruch.cuny.edu)
...
Thursdays, 6:30 PM – 8:30 PM GradCenter 6418
...
25% Labs (in-class applied exercises, one per week) 45% Homework (7 coding problem sets \+ 2 design memos) 5% Final Paper Presentation 25% Final Paper
...
[Full Syllabus](http://assets/docs/CUNY-GC-causal-analysis-syllabus-merged.docx)

| Description | Week | Slides | Labs | Homework |
| :---- | :---- | :---- | :---- | :---- |
| Regression/R Refresher | 1 — Sept 3 | [Slides](http://assets/docs/intro-to-causal-thinking.pptx) | [R Refresher (warm-up)](http://assets/docs/r-refresher-warmup.docx) | — |
| Stratification, Regression, and Causal Adjustment | 2 — Sept 10 | — | [Lab 1](http://assets/docs/lab1-confounders-vs-colliders.docx) | [Homework 1 (PS1)](http://assets/docs/homework1-problemset1-sensitivity-analysis.docx) |
| Potential Outcomes and DAGs | 3 — Sept 17 | — | [Lab 2](http://assets/docs/lab2-dags-and-ate-preview.docx) | [Homework 2 (PS2)](http://assets/docs/homework2-problemset2-ate-att-atu.docx) |
| Randomized Controlled Trials | 4 — Sept 24 | — | [Lab 3](http://assets/docs/lab3-rct-experiments-and-balance-table.docx) | [Homework 3 (PS3)](http://assets/docs/homework3-problemset3-rct-heterogeneity.docx) |
| Matching and Propensity Scores | 5 — Oct 1 | — | [Lab 4](http://assets/docs/week5-matching-lab-hw.docx) | Problem Set 4 |
| Weighting, Bad Controls, Post-Treatment Bias | 6 — Oct 8 | — | [Lab 5](http://assets/docs/week6-weighting-lab-hw.docx) | Design Memo |
| Fixed Effects | 7 — Oct 15 | — | [Lab 6](http://assets/docs/week7-fixed-effects-lab-hw.docx) | Problem Set 5 |
| DiD I: Replicating Legewie & Fagan | 8 — Oct 22 | — | [Lab 7](http://assets/docs/week8-did-legewie-fagan-lab-hw.docx) | Design Memo |
| DiD II: Event Studies and Heterogeneity | 9 — Oct 29 | — | [Lab 8](http://assets/docs/week9-event-studies-lab-hw.docx) | Problem Set 6 |
| Boundary Designs / Proximity Policing | 10 — Nov 5 | — | [Lab 9](http://assets/docs/week10-boundary-nycha-nypd-lab-hw.docx) | — |
| Research Question Workshop | 11 — Nov 12 | — | [Lab 10](http://assets/docs/week11-research-questions-workshop-guide.docx) | Final Paper Outline |
| IV, RD, Sensitivity | 12 — Nov 19 | — | [Lab 11](http://assets/docs/week12-iv-rd-sensitivity-lab-hw.docx) | Problem Set 7 |
| *No class (Thanksgiving)* | — Nov 26 | — | — | — |
| External Validity and Paper Workshop | 13 — Dec 3 | — | [Lab 12](http://assets/docs/week13-external-validity-workshop-guide.docx) | — |
| Final Paper Presentations | 14 — Dec 10 | [Guidelines & Rubric](http://assets/docs/final-presentation-guidelines-rubric.docx) | — | Final Paper Due |
